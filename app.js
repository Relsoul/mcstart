...
app.on('ready', function() {
    ...
    mainWindow.loadURL(`file://${path.join(asarPath,"/dev/service/template/index.html")}`);
...
ipc.on('Info:get',function(event,arg){
    require("./app.asar/dev/service/js/getInfo.js")(event,arg,app_path)

});

ipc.on("searchJave:search",function(event,arg){
    require("./app.asar/dev/service/js/searchJava.js")(event,arg)
});


ipc.on("startGame",function(event,arg){
    require("./app.asar/dev/service/js/startGame.js")(event,arg,app_path)
});
